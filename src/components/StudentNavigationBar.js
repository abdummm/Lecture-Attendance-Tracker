  ...
  return (
    <nav className="bg-blue-500 text-white p-4 flex items-center justify-between relative">
      ...
      <div className="flex-grow flex justify-center gap-4">
        ...
        <Link to="/scanQR" className="hover:underline">Scan QR</Link>
      </div>
      <div onClick={() => setShowDropdown(!showDropdown)} className="flex items-center cursor-pointer">
        <img src="/Default_pfp.png" alt="Profile" className="h-6 w-6" />
        {showDropdown && (
